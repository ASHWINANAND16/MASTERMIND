...
computer_color_code=[[color_1,color_2,color_3,color_4]]
...
#to check the entered code and draw the clues
def check_code():
    global screen,check,computer_color_code,turn

    #to check color at position 1
    if code[0][0]==computer_color_code[0][0] or computer_color_code[0][1] or computer_color_code[0][2] or computer_color_code[0][3]:
        if code[0][0]==computer_color_code[0][0]:
            check[0]="red"
        else:
            if code[0][0]==computer_color_code[0][1] and code[0][1]!=computer_color_code[0][1]:
                check[0]="white"
            else:
                if code[0][0]==computer_color_code[0][2] and code[0][2]!=computer_color_code[0][2]:
                    check[0]="white"
                else:
                    if code[0][0]==computer_color_code[0][3] and code[0][3]!=computer_color_code[0][3]:
                        check[0]="white"

    #to check color at position 2
    if code[0][1]==computer_color_code[0][0] or computer_color_code[0][1] or computer_color_code[0][2] or computer_color_code[0][3]:
        if code[0][1]==computer_color_code[0][1]:
            check[1]="red"
        else:
            if code[0][1]==computer_color_code[0][2] and code[0][2]!=computer_color_code[0][2]:
                check[1]="white"
            else:
                if code[0][1]==computer_color_code[0][3] and code[0][3]!=computer_color_code[0][3]:
                    check[1]="white"
                else:
                    if code[0][1]==computer_color_code[0][0] and code[0][0]!=computer_color_code[0][0]:
                        check[1]="white"

    #to check color at position 3
    if code[0][2]==computer_color_code[0][0] or computer_color_code[0][1] or computer_color_code[0][2] or computer_color_code[0][3]:
        if code[0][2]==computer_color_code[0][2]:
            check[2]="red"
        else:
            if code[0][2]==computer_color_code[0][3] and code[0][3]!=computer_color_code[0][3]:
                check[2]="white"
            else:
                if code[0][2]==computer_color_code[0][0] and code[0][0]!=computer_color_code[0][0]:
                    check[2]="white"
                else:
                    if code[0][2]==computer_color_code[0][1] and code[0][1]!=computer_color_code[0][1]:
                        check[2]="white"

    #to check color at position 4
    if code[0][3]==computer_color_code[0][0] or computer_color_code[0][1] or computer_color_code[0][2] or computer_color_code[0][3]:
        if code[0][3]==computer_color_code[0][3]:
            check[3]="red"
        else:
            if code[0][3]==computer_color_code[0][0] and code[0][0]!=computer_color_code[0][0]:
                check[3]="white"
            else:
                if code[0][3]==computer_color_code[0][1] and code[0][1]!=computer_color_code[0][1]:
                    check[3]="white"
                else:
                    if code[0][3]==computer_color_code[0][2] and code[0][2]!=computer_color_code[0][2]:
                        check[3]="white"
